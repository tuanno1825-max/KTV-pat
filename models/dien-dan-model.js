...
const BinhLuanSchema = new mongoose.Schema(
  {
    ...
    avatarNguoiBinhLuan: { type: String, default: "", trim: true },
    avatarZoomBinhLuan: { type: Number, default: 1.4, min: 1, max: 2.2 },
...
const BaiVietSchema = new mongoose.Schema(
  {
    ...
    avatarNguoiDang: { type: String, default: "", trim: true },
    avatarZoomNguoiDang: { type: Number, default: 1.4, min: 1, max: 2.2 },
    laVip: { type: Boolean, default: false },
