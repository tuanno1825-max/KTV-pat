...
const DonHangSchema = new mongoose.Schema(
  {
    ...
    trangThai: {
      type: String,
      enum: ["Đang chờ xử lý", "Đã xác nhận", "Đặt phòng thành công", "Đặt phòng thất bại", "Đề xuất quán mới", "Khách đã chấp nhận đề xuất", "Khách từ chối đề xuất", "Khách đã hủy đặt phòng"],
